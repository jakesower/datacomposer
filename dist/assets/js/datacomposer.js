...
},{"./datacomposer":8,"./templates/datacomposer.tpl":26,"./views/controls.js":29,"./views/grid.js":32,"backbone":3,"jquery":5}],2:[function(require,module,exports){
/*
	Baby Parse
	v0.4.1
...
},{"jquery":5,"lodash":6}],10:[function(require,module,exports){
...
},{"./data-types.js":12,"lodash":6}],11:[function(require,module,exports){
var _ = require('lodash'),
    Backbone = require('backbone'),
...
},{"../lib/facets.js":13,"../lib/utils.js":16,"./column.js":10,"./data-types.js":12,"backbone":3,"lodash":6}],12:[function(require,module,exports){
/**
...
},{"./column.js":10,"./data-collection.js":11,"./data-types.js":12,"./utils.js":16,"babyparse":2,"lodash":6}],16:[function(require,module,exports){
var $ = require('jquery'),
    _ = require('lodash');
...
'</td>\n  <td class="input"><input type="checkbox" id="used" '+
((__t=( column.used ? ' checked' : ''))==null?'':_.escape(__t))+
'></td>\n  <td class="input"><input type="checkbox" id="visible" '+
((__t=( column.visible ? ' checked' : ''))==null?'':_.escape(__t))+
'></td>\n</tr>\n';
}
return __p;
};
...
((__t=( (_.include( selectedColumns, column.id )) ? ' checked' : '' ))==null?'':_.escape(__t))+
'></td>\n      </tr>\n    ';
 }); 
__p+='\n  </tbody>\n</table>\n';
}
...
__p+='\n  <li class="grouping">\n    <span class="text">'+
((__t=( facet.facet ))==null?'':_.escape(__t))+
' ('+
((__t=( columnNames.join(", ") ))==null?'':_.escape(__t))+
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<button id="exportCSV">Export CSV</button>';
}
return __p;
};
...
__p+='<div class="num-results">'+
((__t=( numResults ))==null?'':_.escape(__t))+
' result'+
((__t=( (numResults === 1) ? "" : "s" ))==null?'':_.escape(__t))+
'</div>';
...
__p+='<button class="page" data-page="1">1</button>';

      if( startPage > 2 ) {
        
__p+='<div class="dot-divider">...</div>';

      }
    }
    for(var i=startPage;i<=endPage;++i) {
      
__p+='<button class="page'+
((__t=( (i == page) ? " selected" : "" ))==null?'':_.escape(__t))+
'" data-page="'+
...
__p+='<button class="page" data-page="'+
((__t=( numPages ))==null?'':_.escape(__t))+
'">'+
((__t=( numPages ))==null?'':_.escape(__t))+
'</button>';
...
__p+='<input id="setPage" type="number" min="1" max="'+
((__t=( numPages ))==null?'':_.escape(__t))+
'" value="'+
...
'"'+
((__t=( (x === perPage) ? " selected" : "" ))==null?'':_.escape(__t))+
'>'+
((__t=( x ))==null?'':_.escape(__t))+
' per page</option>';
...
((__t=( column.type ))==null?'':_.escape(__t))+
''+
((__t=( sortClass ))==null?'':_.escape(__t))+
'" data-columnid="'+
((__t=( column.id ))==null?'':_.escape(__t))+
'">\n        '+
...
((__t=( column.type ))==null?'':_.escape(__t))+
'">'+
((__t=( column.toString( row[column.id] ) ))==null?'':__t)+
'</td>\n        ';
 }); 
__p+='\n      </tr>\n    ';
 }); 
...
},{"../datacomposer.js":8,"../templates/controls/columns-column.tpl":18,"../templates/controls/columns.tpl":19,"backbone":3,"jquery":5,"lodash":6}],29:[function(require,module,exports){
var $ = require('jquery'),
    _ = require('lodash'),
...
},{"../datacomposer.js":8,"../lib/accordion.js":9,"../templates/control.tpl":17,"./columns.js":28,"./facets.js":30,"./filters.js":31,"./groupings.js":33,"./save.js":34,"./source.js":35,"backbone":3,"jquery":5,"lodash":6}],30:[function(require,module,exports){
var $ = require('jquery'),
    _ = require('lodash'),
    Backbone = require('backbone'),
    DataComposer = require('../datacomposer.js'),
...
},{"../datacomposer.js":8,"../lib/facets.js":13,"../templates/controls/facets.tpl":20,"backbone":3,"jquery":5,"lodash":6}],31:[function(require,module,exports){
var $ = require('jquery'),
    _ = require('lodash'),
    Backbone = require('backbone'),
    DataComposer = require('../datacomposer.js'),
...
},{"../datacomposer.js":8,"../lib/data-types.js":12,"../templates/controls/filters.tpl":21,"backbone":3,"jquery":5,"lodash":6}],32:[function(require,module,exports){
var $ = require('jquery'),
    _ = require('lodash'),
    Backbone = require('backbone'),
    Utils = require('../lib/utils.js'),
...
*/
},{"../datacomposer.js":8,"../lib/utils.js":16,"../templates/grid.tpl":27,"backbone":3,"jquery":5,"lodash":6}],33:[function(require,module,exports){
var $ = require('jquery'),
    _ = require('lodash'),
    Backbone = require('backbone'),
    DataComposer = require('../datacomposer.js'),
...
},{"../datacomposer.js":8,"../templates/controls/groupings.tpl":22,"backbone":3,"jquery":5,"lodash":6}],34:[function(require,module,exports){
var $ = require('jquery'),
    _ = require('lodash'),
    Backbone = require('backbone'),
    DataComposer = require('../datacomposer.js'),
...
},{"../datacomposer.js":8,"../lib/importer.js":15,"../lib/utils.js":16,"../templates/controls/source-tree.tpl":24,"../templates/controls/source.tpl":25,"backbone":3,"jquery":5,"lodash":6}]},{},[1])(1)
});